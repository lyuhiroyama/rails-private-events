...
class RegistrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registration" do
    assert_difference("Registration.count") do
      post registrations_url, params: { registration: { event_id_id: @registration.event_id_id, user_id_id: @registration.user_id_id } }
    end
  ...
  test "should update registration" do
    patch registration_url(@registration), params: { registration: { event_id_id: @registration.event_id_id, user_id_id: @registration.user_id_id } }
